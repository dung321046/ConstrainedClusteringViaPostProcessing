...
class DCC(nn.Module):
    ...
    def fit(self, stat, anchor, positive, negative, ml_ind1, ml_ind2, cl_ind1, cl_ind2, mask, use_global, ml_p, cl_p, X,
        ...
        for epoch in range(num_epochs):
            if epoch % update_interval == 0:
                ...
                y_pred_last = y_pred
                stat.append((final_nmi, final_acc, num_vcon, delta_label))
            ...
            if instance_constraints_loss_val != 0.0:
                ...
                print("#Epoch %3d: Total: %.4f Clustering Loss: %.4f Reconstruction Loss: %.4f Global Loss: %.4f" % (
                    epoch + 1, train_loss / num + global_loss_val / num_batch, cluster_loss_val / num,
